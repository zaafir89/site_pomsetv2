...
<div class="row">
  <div class="col-lg-offset-6 col-lg-6 col-xs-12 marge4">
    <p class="premier-titre espace-lien"><strong>une idée performante / City AREAS pour les non salariés</strong></p>
  </div>
</div>
      ...
      <div class="row">
        <div class="col-lg-offset-6 col-lg-6">
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <img src="img/areas/B_AREAS.png" class="img-responsive image-gauche" alt="work"/>
          </div>
          <span class="ecart"></span>
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <img src="img/areas/C_AREAS.png" class="img-responsive image-droite" alt="work"/>
          </div>
        </div>
